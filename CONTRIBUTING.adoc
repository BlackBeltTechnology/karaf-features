# Contributing to karaf-features-antlr

## Installing the correct versions of Java, Maven and necessary dependencies

karaf-features-antlr is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/karaf-features-antlr/issues/new/choose[issue form].
